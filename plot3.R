...
## Task: Reconstruct Plot 3 using the base plotting system.
## Assumptions: 
...
## Notes:
##    1. We have been required to reconstruct Plot 3 saving it to a png file 
...
# Creating the plot and sending it to the "plot3.png" file
